...
In salesapplication-labels_en.properties:
salesapplication=My application
salesapplication[description]=My application does this and that

In salesapplication-messages_en.properties:
